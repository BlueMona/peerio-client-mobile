    ...
    Peerio.UI.Confirm = React.createClass({
        ...
        render: function () {
            ...
            var btns = this.props.btns ||
                    <div>
                        <Peerio.UI.Tappable element="div" className="btn-danger" onTap={this.handleCancel}>{this.props.cancelText || t('button_cancel')}</Peerio.UI.Tappable>
                        <Peerio.UI.Tappable element="div" className="btn-safe" onTap={this.handleAction}>{this.props.okText || t('button_ok')}</Peerio.UI.Tappable>
                    </div>;
